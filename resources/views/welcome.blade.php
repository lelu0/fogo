...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-165598857-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-165598857-1');
    </script>
    ...
    <div class="container">
        ...
        <div class="row sticky" id="top">
            <div class="col-md-10 offset-md-2 col-sm-12 align-self-center">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="https://tipply.pl/u/fogo_esports" target='_blank'><img src='/gfx/icons/paypal.png' height="20" class='mr-1'>DONATE</a>
                    </li>
                    <li class="nav-item">
